...
class MainApp(tk.Frame):
    ...
    def save_profile(self):
        ...
        if len(self.body.get_text()) == 0 or self.body.get_text().isspace() is True:
            ...
            if self.body._recipient is None:
                ...
                more = ms.DirectMessenger(
                    self._current_profile.dsuserver,
    ...
    def _draw(self):
        ...
        self.footer = Footer(
            self.root, send_callback=self.save_profile, add_callback=self.add
        )
